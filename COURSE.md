...
| 课程方向<br>课程子方向 | Name<br>课程名 | Hours<br>课时 | Description<br>简介 | Fee<br>费用 | Quota<br>名额 | Date<br>日期 | Time<br>时间 | Location<br>形式 |
| :-------------: | :------------: | :-----------: | :----------------: | :---------: | :----------: | :--: | :--: | :--: |
...
# 备注
## 课程设置
- ### 你好, 你看到了数学物理的课程, 其中又分为竞赛和大学课程. 一部分课程不一定在高中有用, 也不一定会在本科申请中有用, 但也许可以填补你空余的时间, 也许可以让你的大学更加轻松, 也许可以让你对数学物理的了解更多, 而这也就是本人在这里干的事情. 
## 课程费用
- ### 你好, 你看到了表格里还有'费用'这一栏目:
  - #### 本人已经12年级, 社团去年已经尽职尽责完成了完整的一年的运作, 今年本人仍然想要继续运作此社团, 并希望能在12年级毕业前将社团在学校的事务进行交接, 希望有人能继续在学校运作数理社. 
  - #### 然而事实是去年的社团运作带来的反响优但是少, 可以理解的即为学校中对于数学和物理热爱的同学占少数, 或者对于我的实力或者教学实力不认可的同学占多数. 因此, 在11年级这一年内, 我进行了不少实践, 也让我对于教学这件事有了不同方面的新印象. 同时, 可以承认, 本人的教学实力的确较弱, 但是仍然可以承担社长的以及其他教学事务的工作, 且在本人认知中教授的所有课程都可被学生听懂(不排除学生的反馈有response bias).
- ### 即, 表格中的'费用'是本人对自己的认可, 以及<u>希望</u>从社团中得到物质上的回报(可以理解的是本人几乎不能从社团中得到精神上的回报). 另外, 这种物质的回报客观上讲是可有可无的. 可以计算的是, 100%的课程每小时费用均在100元以下, 90%的课程每小时费用在50元以下. 全部线上课程费用均不超过50元, 的确, 因为线上课程的效果远达不到线下授课. 如果我能在线上教学中发挥较好, 只能表示线下教学中的教学效率会更高. 你也不必担心因为我同意线上教学效果不好我就会在线上教学中划水. 客观严谨考虑, 线上教学也可以带来很多好处, 例如2022年10月我并不在学校里, 线上教学就成为唯一合理的教学手段了. 
- ### 关于课程费用的总结及补充: 
  - #### Affordable, 可支付的. 起象征作用, 当学生付出了一定代价后, 往往会更加认真(唯象的; 往往是正确的).
  - #### 每一个课程的第一节课是免费的(因为表格中为了美观写不下了所以没有提及). 每一位同学都可以免费参与到第一节课的学习中. 同时, 我希望付费学习的同学们能按时参加每一次课程学习. 
  - #### 你看到了有的课程写了'0R/Free', 那意味着这样的课程是全程免费的. 全程免费的原因有几个, 第一, 课程较为简单; 第二, 我第一次上相关内容的课(但不代表我第一次上的课都会是免费的); 第三, 受到一定学生或外界因素的影响. 
  - #### 一对一课程见下. 
  - #### 课程费用是灵活的, 如果参与人数更多, 你需要支付的会相对少一些. 客观上讲我的收入仍然会增加, 主观上我的精神收入也显著增加了(对我来说, 参与的人数越多, 即支持的人更多, 我收到的激励也更多). 同时你所支付的也更少了. 因此, 我认为这是一个win-win的局面. 

## 其他

- ### 我的课程会有几个不同的部分来让你学习, 消化, 吸收. 部分课程会有我个人编写的讲义, 其他时候会是我上课书写的笔记. 因为编写讲义耗时耗力, 所以也请你保护我的知识产权, 不要随意传播. 我会有专门的网站存放这类文件, 你可以分享网站, 也可以告知后分享文件. 但请务必不要将我的名字涂掉后随意分享. 
- ### 前一条是对我最重要的一点, 其他部分可见合同.  
- ### 一对一课程存在, 但是不建议, 因为目前的一对一课程都是我排时间, 而不是你定时间. 不难理解的是这个时间得以我有没有空决定. 另外, 针对竞赛的一对一课程可能出现的情况是由于我的时间与你的时间冲突, 在考试前未能结束课程. 开头的表格中所有的课程和一对一的课程内容都是同样的. 此外, 一对一仅支持线下课程. 计费规则为: 60RMB/1h, 超出第一个1h后未满45分钟不计, 超出45分钟计1h:
- | 时间 | 换算后 | 计费 |
  | :--: | :---: | :--: |
  | 20min | 1h | 60RMB |
  | 45min | 1h | 60RMB |
  ...
  | 1h45min | 2h | 120RMB |
  | 2h59min | 3h | 180RMB |
- ### 写在最后, 你如果想要上课, 除了需要书写合同以外, 还需签署一张学术诚信单. 希望你能意识到作弊可耻, 对你来说是这样, 对'曾经'给你上课的老师也是一样. 
