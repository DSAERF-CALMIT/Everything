...
&= \int r^2 (HdM_A)\\
&= \iint r^2 (H \sigma dA)\\
&= \iint r^2 (H \sigma r d\theta dr)\\
&= \int_{R_1}^{R_2}\int_{-\pi}^{\pi} r^3 H \sigma d\theta dr\\
&= \int_{R_1}^{R_2}  r^3 H \sigma \left(\int_{-\pi}^{\pi} d\theta \right)dr\\
&= \int_{R_1}^{R_2}  r^3 H \sigma 2\pi dr\\
